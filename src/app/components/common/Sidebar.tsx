...
const SIDEBAR_ITEMS = [
  ...
  { name: "negociation", icon: Users, color: "#6366f1", href: "/negociation" },
  { name: "summarize-doc", icon: Users, color: "#6366f1", href: "/summarize-doc" },
  { name: "risk-calculator", icon: Users, color: "#6366f1", href: "/risk-calculator" },
  { name: "quick-incentives", icon: Users, color: "#6366f1", href: "/get-incentives" },
];
