	...
	return (
		...
		>
			<div className='flex justify-between items-center mb-6'>
				<h2 className='text-xl font-semibold text-gray-900 dark:text-gray-100'>Product List</h2>
				...
				<table className='min-w-full divide-y divide-gray-500'>
					...
					<tbody className='divide-y divide-gray-300'>
						{filteredProducts.map((product) => (
							...
							>
								<td className='px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white flex gap-2 items-center'>
									<img
